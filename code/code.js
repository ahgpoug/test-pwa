  ...
  `];Y([d()],x.prototype,"type",2);Y([d()],x.prototype,"deferredPrompt",2);Y([d()],x.prototype,"visible",2);Y([d()],x.prototype,"loadedImages",2);x=Y([$("download-modal-window")],x);const We=new x;class qe{static{this.instance=null}static initialize(){this.instance||(this.instance=We,document.body.appendChild(this.instance))}static show(t="other",e=null){this.initialize(),this.instance.show(t,e)}static hide(){this.instance&&this.instance.hide()}}var Je=Object.defineProperty,Ze=Object.getOwnPropertyDescriptor,Q=(s,t,e,i)=>{for(var r=i>1?void 0:i?Ze(t,e):t,o=s.length-1,n;o>=0;o--)(n=s[o])&&(r=(i?n(t,e,r):n(r))||r);return i&&r&&Je(t,e,r),r};let U=class extends f{constructor(){super(...arguments),this.showInstallButton=!1,this.deferredPrompt=null,this.isIOS=/iPad|iPhone|iPod/.test(navigator.userAgent),this.isAndroid=/Android/.test(navigator.userAgent),this.isInStandaloneMode=window.matchMedia("(display-mode: standalone)").matches||window.navigator.standalone===!0||document.referrer.includes("android-app://"),this.showBackButton=!1,this.isLoginPage=!1,this.onBack=()=>{},this.handleBeforeInstallPrompt=s=>{s.preventDefault(),this.deferredPrompt=s,this.showInstallButton=!0},this.handleInstallClick=async()=>{let s=this.isIOS?"ios":this.isAndroid?"android":"other",t=this.deferredPrompt;qe.show(s,t)},this.handleAppInstalled=()=>{this.showInstallButton=!1}}connectedCallback(){super.connectedCallback(),window.addEventListener("beforeinstallprompt",this.handleBeforeInstallPrompt),window.addEventListener("appinstalled",this.handleAppInstalled)}render(){return l`
    ...
    `,E];Q([d()],U.prototype,"showInstallButton",2);Q([C({type:Boolean})],U.prototype,"showBackButton",2);Q([C({type:Boolean})],U.prototype,"isLoginPage",2);Q([C({type:Function})],U.prototype,"onBack",2);U=Q([$("app-header")],U);class Xe{constructor(){this.baseUrl="https://api.example.com"}async login(t,e){return"eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9..jHWRmpyQBaIFL9xd5fk3gqhPe_m0DtnOQx3J_LD-fTA"}async fetchPaymentHistory(){const t=Math.random()*2e3+1e3;return await new Promise(e=>setTimeout(e,t)),[{id:"1",amount:1e3,date:"2023-10-01",number:"ТПО-123456789012",link:"https://example.com/payment/123456789012",status:"Оплачено"},{id:"2",amount:1500,date:"2023-10-05",number:"ТПО-123456789012",link:"https://example.com/payment/123456789012",status:"Оплачено"},{id:"3",amount:2e3,date:"2023-10-10",number:"ТПО-123456789012",link:"https://example.com/payment/123456789012",status:"Оплачено"}]}async fetchTPOList(t,e){const i=Math.random()*2e3+1e3;await new Promise(o=>setTimeout(o,i));const r=Math.floor(Math.random()*10)+1;return Array.from({length:r},(o,n)=>({id:Math.random().toString(36).substring(2,9),amount:Math.floor(Math.random()*1e5)+1e3,date:new Date(Date.now()-Math.random()*31536e6).toISOString().split("T")[0],number:`ТПО-${Math.floor(Math.random()*1e6)}`}))}}const _t=new Xe;class Pt{static async shareLink(t){try{navigator.share?await navigator.share({title:"Ссылка на платеж",text:"Ссылка для оплаты:",url:t}):(await navigator.clipboard.writeText(t),S.show("Ссылка скопирована в буфер обмена","success"))}catch(e){e.toString().includes("AbortError")||S.show("Произошла ошибка. Пожалуйста, попробуйте позже","error")}}}var Ke=Object.defineProperty,Ge=Object.getOwnPropertyDescriptor,tt=(s,t,e,i)=>{for(var r=i>1?void 0:i?Ge(t,e):t,o=s.length-1,n;o>=0;o--)(n=s[o])&&(r=(i?n(t,e,r):n(r))||r);return i&&r&&Ke(t,e,r),r};let T=class extends f{constructor(){super(...arguments),this.tpos=[],this.fio="",this.passportSeriesNumber="",this.isFormValid=!1,this.fioRegex=/^((?![\s’(),.-])+[А-Яа-яЁёIV’(),.-]{2,}\s(?<![’(),.-]))+((?![\s’(),.-])+[А-Яа-яЁёIV’(),.-]{2,}(?<![\s’(),.-]))+$/,this.passportSeriesNumberRegex=/^\d{4}\s\d{6}$/}async handleSearchTPO(){m.show(),this.tpos=[];try{const s=await _t.fetchTPOList(this.fio.trim(),this.passportSeriesNumber);this.tpos=s}catch{S.show("Произошла ошибка. Пожалуйста, попробуйте позже","error")}finally{this.clearForm(),m.hide()}}clearForm(){this.fio="",this.passportSeriesNumber="",this.validateForm()}validateForm(){const s=this.fioRegex.test(this.fio),t=this.passportSeriesNumberRegex.test(this.passportSeriesNumber);this.isFormValid=s&&t}handleFioInput(s){this.fio=s.target.value;const t=s.target,e=t.selectionStart;let i=t.value.replace(/[^А-Яа-яЁёIV’()\s,.-]+/g,"").replace(/\s+/g," ");this.fio=i,requestAnimationFrame(()=>{if(e){const r=this.calculateNewCursorPosition(e,t.value,i);t.setSelectionRange(r,r)}}),this.validateForm(),t.value=this.fio}handlePassportSeriesNumberInput(s){const t=s.target,e=t.selectionStart;let i=t.value.replace(/[^\d]/g,""),r="";i.length>0&&(r=i.slice(0,4),i.length>4&&(r+=" "+i.slice(4,10))),this.passportSeriesNumber=r,requestAnimationFrame(()=>{if(e){const o=this.calculateNewCursorPosition(e,t.value,r);t.setSelectionRange(o,o)}}),this.validateForm(),t.value=this.passportSeriesNumber}calculateNewCursorPosition(s,t,e){const i=e.length-t.length;return s+i}async generateLink(s){m.show();const t=Math.random()*2e3+1e3;await new Promise(r=>setTimeout(r,t));const e=Math.random().toString(36).substring(2,8),i=this.tpos.map(r=>r.id===s.id?{...r,link:`${window.location.origin}/payment/${e}`}:r);this.tpos=i,m.hide(),S.show("Ссылка успешно создана","success")}render(){return l`
      ...
      `,E];tt([d()],T.prototype,"tpos",2);tt([d()],T.prototype,"fio",2);tt([d()],T.prototype,"passportSeriesNumber",2);tt([d()],T.prototype,"isFormValid",2);T=tt([$("search-tpo")],T);function Ht(s){return!0}var Ye=Object.defineProperty,Qe=Object.getOwnPropertyDescriptor,R=(s,t,e,i)=>{for(var r=i>1?void 0:i?Qe(t,e):t,o=s.length-1,n;o>=0;o--)(n=s[o])&&(r=(i?n(t,e,r):n(r))||r);return i&&r&&Ye(t,e,r),r};let b=class extends f{constructor(){super(...arguments),this.fio="",this.inn="",this.passportSeriesNumber="",this.passportIssueDate="",this.isFormValid=!1,this.generatedLink="",this.fioRegex=/^((?![\s’(),.-])+[А-Яа-яЁёIV’(),.-]{2,}\s(?<![’(),.-]))+((?![\s’(),.-])+[А-Яа-яЁёIV’(),.-]{2,}(?<![\s’(),.-]))+$/,this.innRegex=/^\d{12}$/,this.passportSeriesNumberRegex=/^\d{4}\s\d{6}$/}async handleGenerateLink(){m.show(),this.generatedLink="";try{const s=Math.random()*2e3+1e3;await new Promise(t=>setTimeout(t,s)),this.generateRandomLink()}catch{S.show("Произошла ошибка. Пожалуйста, попробуйте позже","error")}finally{this.clearForm(),m.hide(),S.show("Ссылка успешно создана","success")}}clearForm(){this.fio="",this.inn="",this.passportSeriesNumber="",this.passportIssueDate="",this.validateForm()}generateRandomLink(){const s=Math.random().toString(36).substring(2,8);this.generatedLink=`${window.location.origin}/payment/${s}`}validateForm(){const s=this.fioRegex.test(this.fio),t=this.innRegex.test(this.inn)&&Ht(this.inn),e=this.passportSeriesNumberRegex.test(this.passportSeriesNumber),i=this.validatePassportIssueDate(this.passportIssueDate);this.isFormValid=s&&t&&e&&i}validatePassportIssueDate(s){return s?new Date(s)<=new Date:!1}handleFioInput(s){this.fio=s.target.value;const t=s.target,e=t.selectionStart;let i=t.value.replace(/[^А-Яа-яЁёIV’()\s,.-]+/g,"").replace(/\s+/g," ");this.fio=i,requestAnimationFrame(()=>{if(e){const r=this.calculateNewCursorPosition(e,t.value,i);t.setSelectionRange(r,r)}}),this.validateForm(),t.value=this.fio}handleInnInput(s){this.inn=s.target.value.replace(/\D/g,"");const t=s.target,e=t.selectionStart;let i=t.value.replace(/[^\d]/g,""),r="";i.length>0&&(r=i.slice(0,12)),this.inn=r,requestAnimationFrame(()=>{if(e){const o=this.calculateNewCursorPosition(e,t.value,r);t.setSelectionRange(o,o)}}),this.validateForm(),t.value=this.inn}handlePassportSeriesNumberInput(s){const t=s.target,e=t.selectionStart;let i=t.value.replace(/[^\d]/g,""),r="";i.length>0&&(r=i.slice(0,4),i.length>4&&(r+=" "+i.slice(4,10))),this.passportSeriesNumber=r,requestAnimationFrame(()=>{if(e){const o=this.calculateNewCursorPosition(e,t.value,r);t.setSelectionRange(o,o)}}),this.validateForm(),t.value=this.passportSeriesNumber}calculateNewCursorPosition(s,t,e){const i=e.length-t.length;return s+i}handlePassportIssueDateInput(s){this.passportIssueDate=s.target.value,this.validateForm()}render(){return l`
            ...
            `:""}
        `}};b.styles=[E];R([d()],b.prototype,"fio",2);R([d()],b.prototype,"inn",2);R([d()],b.prototype,"passportSeriesNumber",2);R([d()],b.prototype,"passportIssueDate",2);R([d()],b.prototype,"isFormValid",2);R([C({type:String})],b.prototype,"generatedLink",2);b=R([$("advance-payment")],b);/**
 * @license
 ...
 */const zt=s=>!ts(s)&&typeof s.then=="function",Ft=1073741823;class ds extends ls{constructor(){super(...arguments),this._$Cwt=Ft,this._$Cbt=[],this._$CK=new hs(this),this._$CX=new cs}render(...t){return t.find(e=>!zt(e))??P}update(t,e){const i=this._$Cbt;let r=i.length;this._$Cbt=e;const o=this._$CK,n=this._$CX;this.isConnected||this.disconnected();for(let h=0;h<e.length&&!(h>this._$Cwt);h++){const a=e[h];if(!zt(a))return this._$Cwt=h,a;h<r&&a===i[h]||(this._$Cwt=Ft,r=0,Promise.resolve(a).then(async u=>{for(;n.get();)await n.get();const p=o.deref();if(p!==void 0){const c=p._$Cbt.indexOf(a);c>-1&&c<p._$Cwt&&(p._$Cwt=c,p.setValue(u))}}))}return P}disconnected(){this._$CK.disconnect(),this._$CX.pause()}reconnected(){this._$CK.reconnect(this),this._$CX.resume()}}const ps=is(ds);var us=Object.getOwnPropertyDescriptor,gs=(s,t,e,i)=>{for(var r=i>1?void 0:i?us(t,e):t,o=s.length-1,n;o>=0;o--)(n=s[o])&&(r=n(r)||r);return r};let ft=class extends f{async renderPaymentLinks(){m.show();const s=await _t.fetchPaymentHistory(),t=l`${s.map(e=>this.renderPaymentLinkCard(e))}`;return m.hide(),t}renderPaymentLinkCard(s){return l`
        ...
        `,E];ft=gs([$("payment-history")],ft);var fs=Object.defineProperty,ms=Object.getOwnPropertyDescriptor,z=(s,t,e,i)=>{for(var r=i>1?void 0:i?ms(t,e):t,o=s.length-1,n;o>=0;o--)(n=s[o])&&(r=(i?n(t,e,r):n(r))||r);return i&&r&&fs(t,e,r),r};let A=class extends f{constructor(){super(...arguments),this.login="",this.password="",this.rememberMe=!1,this.isFormValid=!1,this.onSuccessLogin=()=>{}}validateForm(){const s=this.login.length>0,t=this.password.length>0;this.isFormValid=s&&t}async firstUpdated(){if(O.supportsCredentialsAPI()){const s=await navigator.credentials.get({password:!0,mediation:"optional"});s&&"password"in s&&(this.login=s.id,this.password=s.password??"",this.handleLogin())}}handleLoginInput(s){this.login=s.target.value,this.validateForm()}handlePasswordInput(s){this.password=s.target.value,this.validateForm()}async handleLogin(){try{const s=await _t.login(this.login,this.password);if(O.setToken(s),this.rememberMe&&O.supportsCredentialsAPI()){const t=new PasswordCredential({id:this.login,password:this.password,name:this.login});await navigator.credentials.store(t)}this.onSuccessLogin()}catch{S.show("Ошибка авторизации","error")}}render(){return O.isAuthenticated()&&this.onSuccessLogin(),l`
            <input id="login"
                type="text"
                .value="${this.login}"
        ...
        ></login-page>`}renderHome(){return l`
            ...
            <button class="action-button" @click="${()=>O.logout()}">Смена пользователя</button>
        ...
        `;return m.hide(),s}};K.styles=[E];St([C({type:String})],K.prototype,"currentPage",2);St([C({type:Boolean})],K.prototype,"showBackButton",2);K=St([$("app-home")],K);
