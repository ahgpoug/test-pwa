...
`;var He=Object.defineProperty,ze=Object.getOwnPropertyDescriptor,pt=(s,t,e,i)=>{for(var r=i>1?void 0:i?ze(t,e):t,o=s.length-1,n;o>=0;o--)(n=s[o])&&(r=(i?n(t,e,r):n(r))||r);return i&&r&&He(t,e,r),r};let M=class extends f{constructor(){super(...arguments),this.heading="",this.message="",this.visible=!1}show(s,t){this.heading=s,this.message=t,this.visible=!0}hide(){this.visible=!1,this.heading="",this.message=""}render(){return l`
    ...
    `];pt([d()],M.prototype,"heading",2);pt([d()],M.prototype,"message",2);pt([d()],M.prototype,"visible",2);M=pt([v("modal-window")],M);const Fe=new M;class Ve{static{this.instance=null}static initialize(){this.instance||(this.instance=Fe,document.body.appendChild(this.instance))}static show(t,e){this.initialize(),this.instance.show(t,e)}static hide(){this.instance&&this.instance.hide()}}var je=Object.defineProperty,Be=Object.getOwnPropertyDescriptor,G=(s,t,e,i)=>{for(var r=i>1?void 0:i?Be(t,e):t,o=s.length-1,n;o>=0;o--)(n=s[o])&&(r=(i?n(t,e,r):n(r))||r);return i&&r&&je(t,e,r),r};let x=class extends f{constructor(){super(...arguments),this.type="other",this.deferredPrompt=null,this.visible=!1,this.loadedImages={}}get basePath(){return"/test-pwa/"}show(s="other",t=null){this.type=s,this.deferredPrompt=t,this.visible=!0}hide(){this.visible=!1}renderStoreIcon(s,t){const e=this.loadedImages[s];return l`
...
3. Нажмите "Добавить"`)}};x.styles=[E,y`
        .platform-section {
            display: grid;
 ...
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const zt=s=>!ts(s)&&typeof s.then=="function",Ft=1073741823;class ds extends ls{constructor(){super(...arguments),this._$Cwt=Ft,this._$Cbt=[],this._$CK=new hs(this),this._$CX=new cs}render(...t){return t.find(e=>!zt(e))??P}update(t,e){const i=this._$Cbt;let r=i.length;this._$Cbt=e;const o=this._$CK,n=this._$CX;this.isConnected||this.disconnected();for(let h=0;h<e.length&&!(h>this._$Cwt);h++){const a=e[h];if(!zt(a))return this._$Cwt=h,a;h<r&&a===i[h]||(this._$Cwt=Ft,r=0,Promise.resolve(a).then(async u=>{for(;n.get();)await n.get();const p=o.deref();if(p!==void 0){const c=p._$Cbt.indexOf(a);c>-1&&c<p._$Cwt&&(p._$Cwt=c,p.setValue(u))}}))}return P}disconnected(){this._$CK.disconnect(),this._$CX.pause()}reconnected(){this._$CK.reconnect(this),this._$CX.resume()}}const ps=is(ds);var us=Object.getOwnPropertyDescriptor,gs=(s,t,e,i)=>{for(var r=i>1?void 0:i?us(t,e):t,o=s.length-1,n;o>=0;o--)(n=s[o])&&(r=n(r)||r);return r};let ft=class extends f{async renderPaymentLinks(){m.show();const s=await _t.fetchPaymentHistory(),t=l`${s.map(e=>this.renderPaymentLinkCard(e))}`;return m.hide(),t}renderPaymentLinkCard(s){return l`
        ...
        `,E];ft=gs([v("payment-history")],ft);var fs=Object.defineProperty,ms=Object.getOwnPropertyDescriptor,H=(s,t,e,i)=>{for(var r=i>1?void 0:i?ms(t,e):t,o=s.length-1,n;o>=0;o--)(n=s[o])&&(r=(i?n(t,e,r):n(r))||r);return i&&r&&fs(t,e,r),r};let A=class extends f{constructor(){super(...arguments),this.login="",this.password="",this.rememberMe=!1,this.isFormValid=!1,this.onSuccessLogin=()=>{}}validateForm(){const s=this.login.length>0,t=this.password.length>0;this.isFormValid=s&&t}async firstUpdated(){if(this.supportsCredentialsAPI()){const s=await navigator.credentials.get({password:!0,mediation:"optional"});s&&"password"in s&&(this.login=s.id,this.password=s.password??"",this.handleLogin())}}supportsCredentialsAPI(){return"credentials"in navigator&&"PasswordCredential"in window}handleLoginInput(s){this.login=s.target.value,this.validateForm()}handlePasswordInput(s){this.password=s.target.value,this.validateForm()}async handleLogin(){try{const s=await _t.login(this.login,this.password);if(nt.setToken(s),this.rememberMe&&this.supportsCredentialsAPI()){const t=new PasswordCredential({id:this.login,password:this.password,name:this.login});await navigator.credentials.store(t)}this.onSuccessLogin()}catch{S.show("Ошибка авторизации","error")}}render(){return nt.isAuthenticated()&&this.onSuccessLogin(),l`
            <input id="login"
                type="text"
                .value="${this.login}"
