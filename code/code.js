 ...
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */function d(s){return S({...s,state:!0,attribute:!1})}class he{constructor(){this.tokenKey="auth_token"}getToken(){return localStorage.getItem(this.tokenKey)}setToken(t){localStorage.setItem(this.tokenKey,t)}clearToken(){localStorage.removeItem(this.tokenKey)}isAuthenticated(){const t=this.getToken();return t?JSON.parse(atob(t.split(".")[1])).exp*1e3>Date.now():!1}logout(){this.clearToken(),window.dispatchEvent(new CustomEvent("navigateto",{detail:"login-page"}))}}const z=new he;var ce=Object.defineProperty,de=Object.getOwnPropertyDescriptor,rt=(s,t,e,n)=>{for(var i=n>1?void 0:n?de(t,e):t,o=s.length-1,r;o>=0;o--)(r=s[o])&&(i=(n?r(t,e,i):r(i))||i);return n&&i&&ce(t,e,i),i};let O=class extends f{constructor(){super(...arguments),this.message="",this.type="info",this.visible=!1}show(s,t="info",e=3e3){this.message=s,this.type=t,this.visible=!0,this.timeoutId&&window.clearTimeout(this.timeoutId),this.timeoutId=window.setTimeout(()=>{this.hide()},e)}hide(){this.visible=!1}render(){return l`
    ...
    `;rt([d()],O.prototype,"message",2);rt([d()],O.prototype,"type",2);rt([d()],O.prototype,"visible",2);O=rt([v("popup-notification")],O);const pe=new O;class P{static{this.instance=null}static initialize(){this.instance||(this.instance=pe,document.body.appendChild(this.instance))}static show(t,e,n){this.initialize(),this.instance.show(t,e,n)}static hide(){this.instance&&this.instance.hide()}}var ue=Object.defineProperty,ge=Object.getOwnPropertyDescriptor,Rt=(s,t,e,n)=>{for(var i=n>1?void 0:n?ge(t,e):t,o=s.length-1,r;o>=0;o--)(r=s[o])&&(i=(n?r(t,e,i):r(i))||i);return n&&i&&ue(t,e,i),i};let q=class extends f{constructor(){super(...arguments),this.visible=!1}show(){this.visible=!0}hide(){this.visible=!1}isVisible(){return this.visible}render(){return l`
...
`;var me=Object.defineProperty,ve=Object.getOwnPropertyDescriptor,at=(s,t,e,n)=>{for(var i=n>1?void 0:n?ve(t,e):t,o=s.length-1,r;o>=0;o--)(r=s[o])&&(i=(n?r(t,e,i):r(i))||i);return n&&i&&me(t,e,i),i};let N=class extends f{constructor(){super(...arguments),this.heading="",this.message="",this.visible=!1}show(s,t){this.heading=s,this.message=t,this.visible=!0}hide(){this.visible=!1,this.heading="",this.message=""}render(){return this.visible?l`
...
3. Нажмите "Добавить"`)}};x.styles=[C,A`
        .platform-section {
            display: grid;
 ...
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const It=s=>!Oe(s)&&typeof s.then=="function",Ot=1073741823;class Ve extends Ue{constructor(){super(...arguments),this._$Cwt=Ot,this._$Cbt=[],this._$CK=new Be(this),this._$CX=new ze}render(...t){return t.find(e=>!It(e))??_}update(t,e){const n=this._$Cbt;let i=n.length;this._$Cbt=e;const o=this._$CK,r=this._$CX;this.isConnected||this.disconnected();for(let h=0;h<e.length&&!(h>this._$Cwt);h++){const a=e[h];if(!It(a))return this._$Cwt=h,a;h<i&&a===n[h]||(this._$Cwt=Ot,i=0,Promise.resolve(a).then(async u=>{for(;r.get();)await r.get();const p=o.deref();if(p!==void 0){const c=p._$Cbt.indexOf(a);c>-1&&c<p._$Cwt&&(p._$Cwt=c,p.setValue(u))}}))}return _}disconnected(){this._$CK.disconnect(),this._$CX.pause()}reconnected(){this._$CK.reconnect(this),this._$CX.resume()}}const je=Me(Ve);var Fe=Object.defineProperty,We=Object.getOwnPropertyDescriptor,qe=(s,t,e,n)=>{for(var i=n>1?void 0:n?We(t,e):t,o=s.length-1,r;o>=0;o--)(r=s[o])&&(i=(n?r(t,e,i):r(i))||i);return n&&i&&Fe(t,e,i),i};let ct=class extends f{async renderPaymentLinks(){m.show();const s=await mt.fetchPaymentHistory(),t=l`${s.map(e=>this.renderPaymentLinkCard(e))}`;return m.hide(),t}renderPaymentLinkCard(s){return l`
        ...
        `,C];ct=qe([v("payment-history")],ct);var Je=Object.defineProperty,Ze=Object.getOwnPropertyDescriptor,lt=(s,t,e,n)=>{for(var i=n>1?void 0:n?Ze(t,e):t,o=s.length-1,r;o>=0;o--)(r=s[o])&&(i=(n?r(t,e,i):r(i))||i);return n&&i&&Je(t,e,i),i};let R=class extends f{constructor(){super(...arguments),this.login="",this.password="",this.onSuccessLogin=()=>{}}async handleLogin(){try{const s=await mt.login(this.login,this.password);z.setToken(s),this.onSuccessLogin()}catch{P.show("Ошибка авторизации","error")}}render(){return z.isAuthenticated()&&this.onSuccessLogin(),l`
        ...
        `}};J.styles=[C];$t([S({type:String})],J.prototype,"currentPage",2);$t([S({type:Boolean})],J.prototype,"showBackButton",2);J=$t([v("app-home")],J);
