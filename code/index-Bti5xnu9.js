...
`;var Vt=Object.defineProperty,Wt=Object.getOwnPropertyDescriptor,tt=(i,t,e,r)=>{for(var s=r>1?void 0:r?Wt(t,e):t,o=i.length-1,n;o>=0;o--)(n=i[o])&&(s=(r?n(t,e,s):n(s))||s);return r&&s&&Vt(t,e,s),s};let k=class extends g{constructor(){super(...arguments),this.surname="",this.passportNumber=""}handleSearch(){console.log("Поиск ТПО:",this.surname,this.passportNumber)}render(){return $`
        ...
        `}};k.styles=[M];tt([u({type:String})],k.prototype,"surname",2);tt([u({type:String})],k.prototype,"passportNumber",2);k=tt([O("search-tpo")],k);var qt=Object.defineProperty,Ft=Object.getOwnPropertyDescriptor,et=(i,t,e,r)=>{for(var s=r>1?void 0:r?Ft(t,e):t,o=i.length-1,n;o>=0;o--)(n=i[o])&&(s=(r?n(t,e,s):n(s))||s);return r&&s&&qt(t,e,s),s};let N=class extends g{constructor(){super(...arguments),this.passportDetails={series:"",number:"",issuedBy:"",issueDate:"",birthDate:""},this.goBack=()=>{}}handleCreateLink(){console.log("Создание ссылки:",this.passportDetails)}render(){return $`
...
//# sourceMappingURL=index-Bti5xnu9.js.map
