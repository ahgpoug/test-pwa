 ...
 */function p(s){return P({...s,state:!0,attribute:!1})}class he{constructor(){this.tokenKey="auth_token"}getToken(){return localStorage.getItem(this.tokenKey)}setToken(t){localStorage.setItem(this.tokenKey,t)}clearToken(){localStorage.removeItem(this.tokenKey)}isAuthenticated(){const t=this.getToken();return t?JSON.parse(atob(t.split(".")[1])).exp*1e3>Date.now():!1}logout(){this.clearToken(),window.dispatchEvent(new CustomEvent("navigateto",{detail:"login-page"}))}}const B=new he;var ce=Object.defineProperty,de=Object.getOwnPropertyDescriptor,rt=(s,t,e,n)=>{for(var i=n>1?void 0:n?de(t,e):t,r=s.length-1,o;r>=0;r--)(o=s[r])&&(i=(n?o(t,e,i):o(i))||i);return n&&i&&ce(t,e,i),i};let E=class extends m{constructor(){super(...arguments),this.message="",this.type="info",this.visible=!1}show(s,t="info",e=3e3){this.message=s,this.type=t,this.visible=!0,this.timeoutId&&window.clearTimeout(this.timeoutId),this.timeoutId=window.setTimeout(()=>{this.hide()},e)}hide(){this.visible=!1}render(){return l`
    ...
    `;rt([p()],E.prototype,"message",2);rt([p()],E.prototype,"type",2);rt([p()],E.prototype,"visible",2);E=rt([v("popup-notification")],E);const pe=new E;class D{static{this.instance=null}static initialize(){this.instance||(this.instance=pe,document.body.appendChild(this.instance))}static show(t,e,n){this.initialize(),this.instance.show(t,e,n)}static hide(){this.instance&&this.instance.hide()}}var ue=Object.defineProperty,ge=Object.getOwnPropertyDescriptor,Rt=(s,t,e,n)=>{for(var i=n>1?void 0:n?ge(t,e):t,r=s.length-1,o;r>=0;r--)(o=s[r])&&(i=(n?o(t,e,i):o(i))||i);return n&&i&&ue(t,e,i),i};let q=class extends m{constructor(){super(...arguments),this.visible=!1}show(){this.visible=!0}hide(){this.visible=!1}isVisible(){return this.visible}render(){return this.visible?l`
...
`;var fe=Object.defineProperty,ve=Object.getOwnPropertyDescriptor,ot=(s,t,e,n)=>{for(var i=n>1?void 0:n?ve(t,e):t,r=s.length-1,o;r>=0;r--)(o=s[r])&&(i=(n?o(t,e,i):o(i))||i);return n&&i&&fe(t,e,i),i};let O=class extends m{constructor(){super(...arguments),this.heading="",this.message="",this.visible=!1}show(s,t){this.heading=s,this.message=t,this.visible=!0}hide(){this.visible=!1,this.heading="",this.message=""}render(){return this.visible?l`
    ...
    `];ot([p()],O.prototype,"heading",2);ot([p()],O.prototype,"message",2);ot([p()],O.prototype,"visible",2);O=ot([v("modal-window")],O);const $e=new O;class be{static{this.instance=null}static initialize(){this.instance||(this.instance=$e,document.body.appendChild(this.instance))}static show(t,e){this.initialize(),this.instance.show(t,e)}static hide(){this.instance&&this.instance.hide()}}var ye=Object.defineProperty,we=Object.getOwnPropertyDescriptor,at=(s,t,e,n)=>{for(var i=n>1?void 0:n?we(t,e):t,r=s.length-1,o;r>=0;r--)(o=s[r])&&(i=(n?o(t,e,i):o(i))||i);return n&&i&&ye(t,e,i),i};let I=class extends m{constructor(){super(...arguments),this.type="other",this.deferredPrompt=null,this.visible=!1}get basePath(){return"/test-pwa/"}show(s="other",t=null){this.type=s,this.deferredPrompt=t,this.visible=!0}hide(){this.visible=!1}render(){return this.visible?l`
            <div class="modal" @click="${this.hide}">
                <div class="modal-content" @click="${s=>s.stopPropagation()}">
                    <button class="modal-close-button" @click="${()=>this.visible=!1}">
                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor">
...
3. Нажмите "Добавить"`)}};I.styles=[A,x`
        .modal {
            position: fixed;
            top: 0;
            left: 0;
  ...
  `];at([p()],I.prototype,"type",2);at([p()],I.prototype,"deferredPrompt",2);at([p()],I.prototype,"visible",2);I=at([v("download-modal-window")],I);const _e=new I;class xe{static{this.instance=null}static initialize(){this.instance||(this.instance=_e,document.body.appendChild(this.instance))}static show(t="other",e=null){this.initialize(),this.instance.show(t,e)}static hide(){this.instance&&this.instance.hide()}}var Pe=Object.defineProperty,Ae=Object.getOwnPropertyDescriptor,X=(s,t,e,n)=>{for(var i=n>1?void 0:n?Ae(t,e):t,r=s.length-1,o;r>=0;r--)(o=s[r])&&(i=(n?o(t,e,i):o(i))||i);return n&&i&&Pe(t,e,i),i};let N=class extends m{constructor(){super(...arguments),this.showInstallButton=!1,this.deferredPrompt=null,this.isIOS=/iPad|iPhone|iPod/.test(navigator.userAgent),this.isAndroid=/Android/.test(navigator.userAgent),this.isInStandaloneMode=window.matchMedia("(display-mode: standalone)").matches||window.navigator.standalone===!0||document.referrer.includes("android-app://"),this.showBackButton=!1,this.isLoginPage=!1,this.onBack=()=>{},this.handleBeforeInstallPrompt=s=>{s.preventDefault(),this.deferredPrompt=s,this.showInstallButton=!0},this.handleInstallClick=async()=>{let s=this.isIOS?"ios":this.isAndroid?"android":"other",t=this.deferredPrompt;xe.show(s,t)},this.handleAppInstalled=()=>{this.showInstallButton=!1}}connectedCallback(){super.connectedCallback(),window.addEventListener("beforeinstallprompt",this.handleBeforeInstallPrompt),window.addEventListener("appinstalled",this.handleAppInstalled)}render(){return l`
    ...
    `,A];X([p()],N.prototype,"showInstallButton",2);X([P({type:Boolean})],N.prototype,"showBackButton",2);X([P({type:Boolean})],N.prototype,"isLoginPage",2);X([P({type:Function})],N.prototype,"onBack",2);N=X([v("app-header")],N);class Se{constructor(){this.baseUrl="https://api.example.com"}async login(t,e){return"eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9..jHWRmpyQBaIFL9xd5fk3gqhPe_m0DtnOQx3J_LD-fTA"}async fetchPaymentHistory(){const t=Math.random()*2e3+1e3;return await new Promise(e=>setTimeout(e,t)),[{id:"1",amount:1e3,date:"2023-10-01",number:"ТПО-123456789012",link:"https://example.com/payment/123456789012",status:"Оплачено"},{id:"2",amount:1500,date:"2023-10-05",number:"ТПО-123456789012",link:"https://example.com/payment/123456789012",status:"Оплачено"},{id:"3",amount:2e3,date:"2023-10-10",number:"ТПО-123456789012",link:"https://example.com/payment/123456789012",status:"Оплачено"}]}async fetchTPOList(t,e){const n=Math.random()*2e3+1e3;await new Promise(r=>setTimeout(r,n));const i=Math.floor(Math.random()*10)+1;return Array.from({length:i},(r,o)=>({id:Math.random().toString(36).substring(2,9),amount:Math.floor(Math.random()*1e5)+1e3,date:new Date(Date.now()-Math.random()*31536e6).toISOString().split("T")[0],number:`ТПО-${Math.floor(Math.random()*1e6)}`}))}}const ft=new Se;class vt{static async shareLink(t){try{navigator.share?await navigator.share({title:"Ссылка на платеж",text:"Ссылка для оплаты:",url:t}):(await navigator.clipboard.writeText(t),D.show("Ссылка скопирована в буфер обмена","success"))}catch(e){e.toString().includes("AbortError")||D.show("Произошла ошибка. Пожалуйста, попробуйте позже","error")}}}var Ce=Object.defineProperty,ke=Object.getOwnPropertyDescriptor,K=(s,t,e,n)=>{for(var i=n>1?void 0:n?ke(t,e):t,r=s.length-1,o;r>=0;r--)(o=s[r])&&(i=(n?o(t,e,i):o(i))||i);return n&&i&&Ce(t,e,i),i};let L=class extends m{constructor(){super(...arguments),this.tpos=[],this.fio="",this.passportSeriesNumber="",this.isFormValid=!1,this.fioRegex=/^((?![\s’(),.-])+[А-Яа-яЁёIV’(),.-]{2,}\s(?<![’(),.-]))+((?![\s’(),.-])+[А-Яа-яЁёIV’(),.-]{2,}(?<![\s’(),.-]))+$/,this.passportSeriesNumberRegex=/^\d{4}\s\d{6}$/}async handleSearchTPO(){f.show(),this.tpos=[];try{const s=await ft.fetchTPOList(this.fio.trim(),this.passportSeriesNumber);this.tpos=s}catch{D.show("Произошла ошибка. Пожалуйста, попробуйте позже","error")}finally{this.clearForm(),f.hide()}}clearForm(){this.fio="",this.passportSeriesNumber="",this.validateForm()}validateForm(){const s=this.fioRegex.test(this.fio),t=this.passportSeriesNumberRegex.test(this.passportSeriesNumber);this.isFormValid=s&&t}handleFioInput(s){this.fio=s.target.value;const t=s.target,e=t.selectionStart;let n=t.value.replace(/[^А-Яа-яЁёIV’()\s,.-]+/g,"").replace(/\s+/g," ");this.fio=n,requestAnimationFrame(()=>{if(e){const i=this.calculateNewCursorPosition(e,t.value,n);t.setSelectionRange(i,i)}}),this.validateForm(),t.value=this.fio}handlePassportSeriesNumberInput(s){const t=s.target,e=t.selectionStart;let n=t.value.replace(/[^\d]/g,""),i="";n.length>0&&(i=n.slice(0,4),n.length>4&&(i+=" "+n.slice(4,10))),this.passportSeriesNumber=i,requestAnimationFrame(()=>{if(e){const r=this.calculateNewCursorPosition(e,t.value,i);t.setSelectionRange(r,r)}}),this.validateForm(),t.value=this.passportSeriesNumber}calculateNewCursorPosition(s,t,e){const n=e.length-t.length;return s+n}async generateLink(s){f.show();const t=Math.random()*2e3+1e3;await new Promise(i=>setTimeout(i,t));const e=Math.random().toString(36).substring(2,8),n=this.tpos.map(i=>i.id===s.id?{...i,link:`${window.location.origin}/payment/${e}`}:i);this.tpos=n,f.hide()}render(){return l`
      ...
      `,A];K([p()],L.prototype,"tpos",2);K([p()],L.prototype,"fio",2);K([p()],L.prototype,"passportSeriesNumber",2);K([p()],L.prototype,"isFormValid",2);L=K([v("search-tpo")],L);function Et(s){return!0}var Ee=Object.defineProperty,Oe=Object.getOwnPropertyDescriptor,M=(s,t,e,n)=>{for(var i=n>1?void 0:n?Oe(t,e):t,r=s.length-1,o;r>=0;r--)(o=s[r])&&(i=(n?o(t,e,i):o(i))||i);return n&&i&&Ee(t,e,i),i};let b=class extends m{constructor(){super(...arguments),this.fio="",this.inn="",this.passportSeriesNumber="",this.passportIssueDate="",this.isFormValid=!1,this.generatedLink="",this.fioRegex=/^((?![\s’(),.-])+[А-Яа-яЁёIV’(),.-]{2,}\s(?<![’(),.-]))+((?![\s’(),.-])+[А-Яа-яЁёIV’(),.-]{2,}(?<![\s’(),.-]))+$/,this.innRegex=/^\d{12}$/,this.passportSeriesNumberRegex=/^\d{4}\s\d{6}$/}async handleGenerateLink(){f.show(),this.generatedLink="";try{const s=Math.random()*2e3+1e3;await new Promise(t=>setTimeout(t,s)),this.generateRandomLink()}catch{D.show("Произошла ошибка. Пожалуйста, попробуйте позже","error")}finally{this.clearForm(),f.hide()}}clearForm(){this.fio="",this.inn="",this.passportSeriesNumber="",this.passportIssueDate="",this.validateForm()}generateRandomLink(){const s=Math.random().toString(36).substring(2,8);this.generatedLink=`${window.location.origin}/payment/${s}`}validateForm(){const s=this.fioRegex.test(this.fio),t=this.innRegex.test(this.inn)&&Et(this.inn),e=this.passportSeriesNumberRegex.test(this.passportSeriesNumber),n=this.validatePassportIssueDate(this.passportIssueDate);this.isFormValid=s&&t&&e&&n}validatePassportIssueDate(s){return s?new Date(s)<=new Date:!1}handleFioInput(s){this.fio=s.target.value;const t=s.target,e=t.selectionStart;let n=t.value.replace(/[^А-Яа-яЁёIV’()\s,.-]+/g,"").replace(/\s+/g," ");this.fio=n,requestAnimationFrame(()=>{if(e){const i=this.calculateNewCursorPosition(e,t.value,n);t.setSelectionRange(i,i)}}),this.validateForm(),t.value=this.fio}handleInnInput(s){this.inn=s.target.value.replace(/\D/g,"");const t=s.target,e=t.selectionStart;let n=t.value.replace(/[^\d]/g,""),i="";n.length>0&&(i=n.slice(0,12)),this.inn=i,requestAnimationFrame(()=>{if(e){const r=this.calculateNewCursorPosition(e,t.value,i);t.setSelectionRange(r,r)}}),this.validateForm(),t.value=this.inn}handlePassportSeriesNumberInput(s){const t=s.target,e=t.selectionStart;let n=t.value.replace(/[^\d]/g,""),i="";n.length>0&&(i=n.slice(0,4),n.length>4&&(i+=" "+n.slice(4,10))),this.passportSeriesNumber=i,requestAnimationFrame(()=>{if(e){const r=this.calculateNewCursorPosition(e,t.value,i);t.setSelectionRange(r,r)}}),this.validateForm(),t.value=this.passportSeriesNumber}calculateNewCursorPosition(s,t,e){const n=e.length-t.length;return s+n}handlePassportIssueDateInput(s){this.passportIssueDate=s.target.value,this.validateForm()}render(){return l`
            ...
            `:""}
        `}};b.styles=[A];M([p()],b.prototype,"fio",2);M([p()],b.prototype,"inn",2);M([p()],b.prototype,"passportSeriesNumber",2);M([p()],b.prototype,"passportIssueDate",2);M([p()],b.prototype,"isFormValid",2);M([P({type:String})],b.prototype,"generatedLink",2);b=M([v("advance-payment")],b);/**
 * @license
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */class ze{constructor(t){this.Y=t}disconnect(){this.Y=void 0}reconnect(t){this.Y=t}deref(){return this.Y}}class Be{constructor(){this.Z=void 0,this.q=void 0}get(){return this.Z}pause(){this.Z??=new Promise(t=>this.q=t)}resume(){this.q?.(),this.Z=this.q=void 0}}/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const Ot=s=>!Ie(s)&&typeof s.then=="function",It=1073741823;class Ve extends Ue{constructor(){super(...arguments),this._$Cwt=It,this._$Cbt=[],this._$CK=new ze(this),this._$CX=new Be}render(...t){return t.find(e=>!Ot(e))??_}update(t,e){const n=this._$Cbt;let i=n.length;this._$Cbt=e;const r=this._$CK,o=this._$CX;this.isConnected||this.disconnected();for(let h=0;h<e.length&&!(h>this._$Cwt);h++){const a=e[h];if(!Ot(a))return this._$Cwt=h,a;h<i&&a===n[h]||(this._$Cwt=It,i=0,Promise.resolve(a).then(async u=>{for(;o.get();)await o.get();const d=r.deref();if(d!==void 0){const c=d._$Cbt.indexOf(a);c>-1&&c<d._$Cwt&&(d._$Cwt=c,d.setValue(u))}}))}return _}disconnected(){this._$CK.disconnect(),this._$CX.pause()}reconnected(){this._$CK.reconnect(this),this._$CX.resume()}}const je=Me(Ve);var Fe=Object.defineProperty,We=Object.getOwnPropertyDescriptor,qe=(s,t,e,n)=>{for(var i=n>1?void 0:n?We(t,e):t,r=s.length-1,o;r>=0;r--)(o=s[r])&&(i=(n?o(t,e,i):o(i))||i);return n&&i&&Fe(t,e,i),i};let ct=class extends m{async renderPaymentLinks(){f.show();const s=await ft.fetchPaymentHistory(),t=l`${s.map(e=>this.renderPaymentLinkCard(e))}`;return f.hide(),t}renderPaymentLinkCard(s){return l`
        ...
        `,A];ct=qe([v("payment-history")],ct);var Je=Object.defineProperty,Ze=Object.getOwnPropertyDescriptor,lt=(s,t,e,n)=>{for(var i=n>1?void 0:n?Ze(t,e):t,r=s.length-1,o;r>=0;r--)(o=s[r])&&(i=(n?o(t,e,i):o(i))||i);return n&&i&&Je(t,e,i),i};let R=class extends m{constructor(){super(...arguments),this.login="",this.password="",this.onSuccessLogin=()=>{}}async handleLogin(){try{const s=await ft.login(this.login,this.password);B.setToken(s),this.onSuccessLogin()}catch{D.show("Ошибка авторизации","error")}}render(){return B.isAuthenticated()&&this.onSuccessLogin(),l`
        ...
        `}};J.styles=[A];$t([P({type:String})],J.prototype,"currentPage",2);$t([P({type:Boolean})],J.prototype,"showBackButton",2);J=$t([v("app-home")],J);
