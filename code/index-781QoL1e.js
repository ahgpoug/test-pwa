...
`;var Vt=Object.defineProperty,Wt=Object.getOwnPropertyDescriptor,tt=(i,t,e,r)=>{for(var s=r>1?void 0:r?Wt(t,e):t,o=i.length-1,n;o>=0;o--)(n=i[o])&&(s=(r?n(t,e,s):n(s))||s);return r&&s&&Vt(t,e,s),s};let k=class extends f{constructor(){super(...arguments),this.surname="",this.passportNumber=""}handleSearch(){console.log("Поиск ТПО:",this.surname,this.passportNumber)}render(){return $`
        ...
        `}};N.styles=[M];et([u({type:Object})],N.prototype,"passportDetails",2);et([u({type:Function})],N.prototype,"goBack",2);N=et([O("advance-payment")],N);var Kt=Object.defineProperty,Jt=Object.getOwnPropertyDescriptor,q=(i,t,e,r)=>{for(var s=r>1?void 0:r?Jt(t,e):t,o=i.length-1,n;o>=0;o--)(n=i[o])&&(s=(r?n(t,e,s):n(s))||s);return r&&s&&Kt(t,e,s),s};let S=class extends f{constructor(){super(...arguments),this.oldPassword="",this.newPassword="",this.confirmPassword=""}handleChangePassword(){this.newPassword===this.confirmPassword?console.log("Смена пароля:",this.oldPassword,this.newPassword):console.error("Пароли не совпадают")}render(){return $`
...
//# sourceMappingURL=index-781QoL1e.js.map
