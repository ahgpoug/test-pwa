 ...
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */function g(r){return f({...r,state:!0,attribute:!1})}const M=st`
    :host {
        display: block;
...
`;class qt{constructor(){this.tokenKey="auth_token"}getToken(){return localStorage.getItem(this.tokenKey)}setToken(t){localStorage.setItem(this.tokenKey,t)}clearToken(){localStorage.removeItem(this.tokenKey)}isAuthenticated(){const t=this.getToken();return t?(console.log(JSON.parse(atob(t.split(".")[1]))),JSON.parse(atob(t.split(".")[1])).exp*1e3>Date.now()):!1}}const C=new qt;var Xt=Object.defineProperty,Zt=Object.getOwnPropertyDescriptor,F=(r,t,e,i)=>{for(var s=i>1?void 0:i?Zt(t,e):t,o=r.length-1,n;o>=0;o--)(n=r[o])&&(s=(i?n(t,e,s):n(s))||s);return i&&s&&Xt(t,e,s),s};let A=class extends m{constructor(){super(...arguments),this.showInstallButton=!1,this.showInstallModal=!1,this.deferredPrompt=null,this.isIOS=/iPad|iPhone|iPod/.test(navigator.userAgent),this.isAndroid=/Android/.test(navigator.userAgent),this.isInStandaloneMode=window.matchMedia("(display-mode: standalone)").matches||window.navigator.standalone===!0||document.referrer.includes("android-app://"),this.showBackButton=!1,this.onBack=()=>{},this.handleBeforeInstallPrompt=r=>{r.preventDefault(),this.deferredPrompt=r,this.showInstallButton=!0},this.handleInstallClick=async()=>{if(this.deferredPrompt){this.deferredPrompt.prompt();const{outcome:r}=await this.deferredPrompt.userChoice;r==="accepted"&&(this.showInstallButton=!1)}else this.showInstallModal=!0},this.handleAppInstalled=()=>{this.showInstallButton=!1}}connectedCallback(){super.connectedCallback(),window.addEventListener("beforeinstallprompt",this.handleBeforeInstallPrompt),window.addEventListener("appinstalled",this.handleAppInstalled)}renderInstallModal(){return h`
    ...
    `,M];I([g()],v.prototype,"fio",2);I([g()],v.prototype,"inn",2);I([g()],v.prototype,"passportSeriesNumber",2);I([g()],v.prototype,"passportIssueDate",2);I([g()],v.prototype,"isFormValid",2);I([f({type:String})],v.prototype,"generatedLink",2);v=I([E("advance-payment")],v);var te=Object.defineProperty,ee=Object.getOwnPropertyDescriptor,G=(r,t,e,i)=>{for(var s=i>1?void 0:i?ee(t,e):t,o=r.length-1,n;o>=0;o--)(n=r[o])&&(s=(i?n(t,e,s):n(s))||s);return i&&s&&te(t,e,s),s};let T=class extends m{constructor(){super(...arguments),this.oldPassword="",this.newPassword="",this.confirmPassword=""}handleChangePassword(){this.newPassword===this.confirmPassword?console.log("Смена пароля:",this.oldPassword,this.newPassword):console.error("Пароли не совпадают")}render(){return h`
        ...
        `}};T.styles=[M];G([f({type:String})],T.prototype,"oldPassword",2);G([f({type:String})],T.prototype,"newPassword",2);G([f({type:String})],T.prototype,"confirmPassword",2);T=G([E("change-password")],T);var se=Object.defineProperty,ie=Object.getOwnPropertyDescriptor,_t=(r,t,e,i)=>{for(var s=i>1?void 0:i?ie(t,e):t,o=r.length-1,n;o>=0;o--)(n=r[o])&&(s=(i?n(t,e,s):n(s))||s);return i&&s&&se(t,e,s),s};let Z=class extends m{constructor(){super(...arguments),this.payments=[{id:1,amount:1e3,date:"2023-10-01"},{id:2,amount:1500,date:"2023-10-05"},{id:3,amount:2e3,date:"2023-10-10"}]}render(){return h`
            <ul>
                ${this.payments.map(r=>h`
                    <li>${r.date} - ${r.amount} руб.</li>
                `)}
            </ul>
        `}};Z.styles=[M];_t([f({type:Array})],Z.prototype,"payments",2);Z=_t([E("payment-history")],Z);class re{constructor(){this.baseUrl="https://api.example.com"}async login(t,e){return"eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9..jHWRmpyQBaIFL9xd5fk3gqhPe_m0DtnOQx3J_LD-fTA"}async fetchProtectedData(){const t=C.getToken();if(!t)throw new Error("Требуется авторизация");const e=await fetch(`${this.baseUrl}/protected`,{headers:{Authorization:`Bearer ${t}`}});if(!e.ok)throw new Error("Ошибка запроса");return e.json()}}const oe=new re;var ne=Object.defineProperty,ae=Object.getOwnPropertyDescriptor,V=(r,t,e,i)=>{for(var s=i>1?void 0:i?ae(t,e):t,o=r.length-1,n;o>=0;o--)(n=r[o])&&(s=(i?n(t,e,s):n(s))||s);return i&&s&&ne(t,e,s),s};let x=class extends m{constructor(){super(...arguments),this.login="",this.password="",this.error="",this.onSuccessLogin=()=>{}}async handleLogin(){try{const r=await oe.login(this.login,this.password);C.setToken(r),this.onSuccessLogin()}catch{this.error="Ошибка авторизации"}}render(){return h`
        ...
        `}};B.styles=[M];nt([f({type:String})],B.prototype,"currentPage",2);nt([f({type:Boolean})],B.prototype,"showBackButton",2);B=nt([E("app-home")],B);
//# sourceMappingURL=index-BiulVa5e.js.map
